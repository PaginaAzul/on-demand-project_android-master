...
public class PastProfessionalWorkerDashboardAdapter extends RecyclerView.Adapter<PastProfessionalWorkerDashboardAdapter.MyViewHolder> {
    ...
    public PastProfessionalWorkerDashboardAdapter(Context context, ArrayList<NormalUserPendingOrderInner> pastList) {
...
//        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.rlRating:
                    context.startActivity(RatingAndRiviewActivity.getIntent(context, pastList.get(getAdapterPosition()), "PastPW"));
                    break;
            }
        }
    }
