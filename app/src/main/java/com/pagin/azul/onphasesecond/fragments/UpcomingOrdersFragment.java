...
public class UpcomingOrdersFragment extends Fragment implements CommonListener {
    ...
    private OnUpcomingAdapter onUpcomingAdapter;
    ...
    public void serviceGetUserOrder() {
        try {
            ...
            jsonObject.put("type", ParamEnum.UPCOMING.theValue());
    ...
    private void setUpRecyclerView(ArrayList<MyOrderResponse> data) {
        if(data!=null && !data.isEmpty()){
            tvNoData.setVisibility(View.GONE);
            rv.setLayoutManager(new LinearLayoutManager(mContext));
            onUpcomingAdapter = new OnUpcomingAdapter(mContext,data,this);
            rv.setAdapter(onUpcomingAdapter);
        }else {
