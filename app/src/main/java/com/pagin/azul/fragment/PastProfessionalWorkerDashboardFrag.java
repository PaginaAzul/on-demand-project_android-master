...
import com.pagin.azul.adapter.PastProfessionalWorkerDashboardAdapter;
...
public class PastProfessionalWorkerDashboardFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        callPastOrderPWorkerApi();
        return view;
    }

    private void callPastOrderPWorkerApi() {
        try {
            ...
            if (!token.isEmpty()) {
                ...
                Call<NormalUserPendingOrderResponse> beanCall = apiInterface.getPastOrderPWorker(token,body);
