...
public class NUActiveProfessionalWorkerFrag extends Fragment {
    private NUActiveProWorkerAdapter activeAdapter;
    ...
    private void findCallback() {
        ...
        activeAdapter.setListener(new NUActiveProWorkerAdapter.ActiveRequireProff() {
            @Override
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (signUpResponce.getStatus().equalsIgnoreCase("SUCCESS")) {
                                ...
                                if (response.body().getDataList() != null && response.body().getDataList().size() > 0) {
                                    ...
                                    activeAdapter = new NUActiveProWorkerAdapter(getActivity(), activeList);
